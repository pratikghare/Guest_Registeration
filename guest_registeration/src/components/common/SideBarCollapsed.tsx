import { User, BarChart, Copy, Bookmark, Users, LogIn, Newspaper, Search, Settings } from "lucide-react";
  ...
  return (
    <aside className="flex h-screen w-16 flex-col items-center overflow-y-auto border-r bg-white py-8">
        ...
        <div className="flex flex-col items-center space-y-6">
            <a href="#" className="rotate-180 text-gray-800 transition-colors duration-200 hover:text-gray-900">
                <LogIn className="h-5 w-5" />
            </a>

            <a href="#" data-dropdown-toggle="dropdown">
                <img className="h-8 w-8 rounded-full object-cover"
                    src="https://avatars.githubusercontent.com/u/65148377?v=4" alt="User avatar" />
            </a>
            <DropDownButton />
        </div>
    </aside>
